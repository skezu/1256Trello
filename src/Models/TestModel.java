...
public class TestModel {
    public static void main(String[] args){
        ...
        EspaceTravailModel e2 =new EspaceTravailModel();
        ...
        EspaceTravailModel espacenom= m.creeEspaceDetravail("un nom");
